...
#	module load boost-1.38.0
	...
	#comment this out when unneeded
...
##paths
export PATH=/PHShome/jje16/Tools/me/bin:$ME/bin:${HOME}/Tools/internal/bin:/scratch/pcpgm/share/software/current/bin:/PHShome/jje16/.local/bin:$SVN/ngs/variant-reporting/annotation/trunk:$PATH

export PERL5LIB=$ME/lib:$SHARE/software/current/lib:$HOME/build/vcftools_0.1.12a/lib/perl5/site_perl:${PERL5LIB}
export PYTHONPATH=$ME/lib:$SHARE/lib/python2.7/site-packages:$HOME/.local/lib/python2.7/site-packages:$PYTHONPATH
